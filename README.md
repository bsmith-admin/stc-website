...
The stylesheet is linked with a version query string (`style.css?v=7`) to avoid stale browser caches after a deploy. Bump that number in all four HTML files whenever `style.css` changes.
